...
func (n *node) addRoute(path string, value interface{}) {
	fullPath := path
	n.priority++
...
func (n *node) insertChild(path, fullPath string, value interface{}) {
	for {
...
// Makes a case-insensitive lookup of the given path and tries to find a value.
